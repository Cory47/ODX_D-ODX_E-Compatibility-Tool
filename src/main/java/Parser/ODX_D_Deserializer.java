...
public class ODX_D_Deserializer {
    ...
    public static void main(String[] args) {
        try {
            ...
            ODX_Model parameterModel = deserializer.deserializeODX();
            //TODO: Any Transformations to the JSON will be performed here
            String jsonString = deserializer.serializeToJson(parameterModel);
    ...
    public ODX_Model deserializeODX() throws IOException {
